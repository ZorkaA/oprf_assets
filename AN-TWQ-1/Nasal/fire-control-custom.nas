...
var setupTime = 30;#minimum 'launcher_tilt_time' secs no matter what, due to anim and stuff.
var reload_time = 30;
...
var NUM_MISSILES = 7; # total carried minus 1
...
var lockon_time = 6; #time in seconds it takes to lock on and get a firing solution on a target
var fire_minimum_interval = 6;# time since last track was initiated till a new can be initiated
